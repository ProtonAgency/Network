...
public abstract class Protocol<HS extends IHandshakePacket> {

    public static final AttributeKey<Protocol<?>> PROTOCOL_ATTR = AttributeKey.valueOf("net_handler");
    ...
    /**
     * Get the name of this {@link Protocol}
     *
     * @return the name
     */
